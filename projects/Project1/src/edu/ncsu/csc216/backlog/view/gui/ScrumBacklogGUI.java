...
public class ScrumBacklogGUI extends JFrame implements ActionListener {
	 ...
	 * {@link JMenuBar} and a {@link JPanel} that will hold different possible views
	 * of the data in the {@link ScrumBacklogModel}.
	 */
	...
	private class TaskItemListPanel extends JPanel implements ActionListener {
		...
		/**
		 * {@link TaskItemTableModel} is the object underlying the {@link JTable} object
		 * that displays the list of {@link TaskItem}s to the user.
		 * 
		 * @author Dr. Sarah Heckman (heckman@csc.ncsu.edu)
		 */
		private class TaskItemTableModel extends AbstractTableModel {
			...
			/**
			 * Constructs the {@link TaskItemTableModel} by requesting the latest
			 * information from the {@link ScrumBacklogModel}.
			 */
			...
			/**
			 * Updates the given model with {@link TaskItem} information from the
			 * {@link ScrumBacklogModel}.
			 */
			...
			/**
			 * Updates the given model with {@link TaskItem} information for the given owner
			...
			/**
			 * Updates the given model with {@link TaskItem} information for the given
			 * creator from the {@link ScrumBacklogModel}.
			 * 
	...
	private class BacklogPanel extends JPanel implements ActionListener {
		...
		private static final long serialVersionUID = 1L;
		/**
		 * {@link TaskItemInfoPanel} that presents the {@link TaskItem}'s information to
		 * the user
		 */
	...
	private class TaskItemInfoPanel extends JPanel {
		...
		/**
		 * {@link NotesTableModel} is the object underlying the {@link JTable} object
		 * that displays the list of Notes to the user.
		 * 
		...
		private class NotesTableModel extends AbstractTableModel {
			...
			/**
			 * Updates the given model with {@link NoteItem} information from the
			 * {@link TaskItem}.
			 */
