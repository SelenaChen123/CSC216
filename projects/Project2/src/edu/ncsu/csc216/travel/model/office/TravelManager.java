 ...
 * reservations. Every class that implements TravelManager must have lists of
 * clients and trips, each of which has its own list of reservations. The list
 * of trips can be filtered.
 * 
 * @author Jo Perry
 */
public interface TravelManager {
	 ...
	 */
	Tour addNewTour(String kind, String name, LocalDate startDate, int duration, int basePrice, int capacity)
