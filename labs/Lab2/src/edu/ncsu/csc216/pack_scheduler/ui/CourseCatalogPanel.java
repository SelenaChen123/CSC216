...
public class CourseCatalogPanel extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btnLoadCourseCatalog) {
			...
			if (comboStartPeriod.getItemAt(periodIdx).equals("PM") && startTime < 1200 && !meetingDays.contains("A")) {
				startTime += 1200;
			}
			...
			if (comboEndPeriod.getItemAt(periodIdx).equals("PM") && endTime < 1200 && !meetingDays.contains("A")) {
				endTime += 1200;
			}
