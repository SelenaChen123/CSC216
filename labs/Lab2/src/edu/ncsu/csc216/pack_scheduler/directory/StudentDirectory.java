 ...
 * a unique id. Has methods to create a new student directory, load students
 * from a file, add students, remove students, get the student directory, and
 * save the student directory to a file.
 * 
...
public class StudentDirectory {
	...
	/**
	 * Searches the students in the StudentDirectory and returns the student with
	 * the matching Id. If no matching student is found, null is returned.
	 * 
	 * @param id Id of the desired student.
	 * @return Student object with matching Id.
	 */
