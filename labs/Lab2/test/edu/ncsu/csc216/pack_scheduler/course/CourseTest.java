...
public class CourseTest {
	...
	public void testCourseStringStringStringIntStringStringIntInt() {
		...
		Course c = null;
		try {
			c = new Course(null, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 15, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		...
		c = null;
		try {
			c = new Course("", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 15, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course("E11", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 15, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course("CSC2167", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 15, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 15, MEETING_DAYS, START_TIME, END_TIME);
	...
	public void testCourseStringStringStringIntStringString() {
		...
		Course c = null;
		try {
			c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 15, "A");
			assertEquals(NAME, c.getName());
			assertEquals(TITLE, c.getTitle());
			assertEquals(SECTION, c.getSection());
			assertEquals(CREDITS, c.getCredits());
	...
	public void testGetMeetingString() {
		...
		Activity c3 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 15, "A");
	...
	public void testEqualsObject() {
		...
		Activity c3 = new Course(NAME, "Different", SECTION, CREDITS, INSTRUCTOR_ID, 15, MEETING_DAYS, START_TIME, END_TIME);
		...
		Activity c9 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 15, MEETING_DAYS, START_TIME, 1400);
	...
	public void testToString() {
		Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 15, MEETING_DAYS, START_TIME, END_TIME);
		String s1 = "CSC216,Programming Concepts - Java,001,4,sesmith5,15,MW,1330,1445";
		assertEquals(s1, c1.toString());

		Activity c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, 15, "A");
		String s2 = "CSC216,Programming Concepts - Java,001,4,sesmith5,15,A";
