...
public class StudentTest {
	...
	public void testHashCode() {
		...
		Student s3 = new Student("Leon", LAST, ID, EMAIL, PASSWORD, MAXCREDITS);
		Student s4 = new Student(FIRST, "John", ID, EMAIL, PASSWORD, MAXCREDITS);
		Student s5 = new Student(FIRST, LAST, "ljohn", EMAIL, PASSWORD, MAXCREDITS);
		Student s6 = new Student(FIRST, LAST, ID, "ljohn@ncsu.edu", PASSWORD, MAXCREDITS);
		Student s7 = new Student(FIRST, LAST, ID, EMAIL, "Ljohn2019!", MAXCREDITS);
		Student s8 = new Student(FIRST, LAST, ID, EMAIL, PASSWORD, REGCREDITS);
	...
	public void testEqualsObject() {
		...
		Student s3 = new Student("firstName", "lastName", "unityid", "studentEmail@ncsu.edu", "password");
		Student s4 = new Student("Mark", "last", "id", "email@ncsu.edu", "hashedpassword");
		Student s5 = new Student("first", "Smith", "id", "email@ncsu.edu", "hashedpassword");
		Student s6 = new Student("first", "last", "msmith", "email@ncsu.edu", "hashedpassword");
		Student s7 = new Student("first", "last", "id", "msmith@ncsu.edu", "hashedpassword");
		Student s8 = new Student("first", "last", "id", "email@ncsu.edu", "Msmith2019!");
