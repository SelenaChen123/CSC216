...
public class StudentDirectoryPanel extends JPanel implements ActionListener {
	...
	/**
	 * Controls what happens when an action is performed by the user.
	 * 
	 * @throws IllegalArgumentException       if inputs are invalid
	 * @throws NumberFormatException          if number inputs are invalid
	 * @throws ArrayIndexOutOfBoundsException if no student is selected
	 */
	@Override
